...
export default function AboutSection() {
  ...
  return (
    <section className="py-32 px-6 bg-[#050B16] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8">
            Engenharia, Tecnologia e <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#E2E8F0]">Confiabilidade</span>
          </h2>

          <p className="text-[#E2E8F0] text-lg font-light leading-relaxed mb-12">
          ...
          <div className="grid grid-cols-2 gap-8">
            {stats.map((stat, i) => (
              <div key={i} className="border-l-2 border-[#E60000] pl-4">
                ...
                <div className="text-sm text-[#E2E8F0] uppercase tracking-wider">{stat.label}</div>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="relative w-full h-[350px] md:h-[450px] overflow-hidden rounded-xl shadow-2xl group bg-[#0A1F44]"
        >
          <img 
            src="/quemsomos.png" 
          ...
          <div className="absolute bottom-8 left-8 text-xs font-mono text-[#E60000] tracking-widest uppercase bg-black/50 px-2 py-1 backdrop-blur-sm rounded">
            SYS_OPERATIONAL // 100%
          </div>
        </motion.div>
      </div>
