        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10 sm:mb-16">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold">
              Resultados na <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#E2E8F0]">Prática</span>
            </h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          {cases.map((c, i) => (
            <motion.div
              ...
              className="bg-[#0A1F44] border border-white/5 overflow-hidden group rounded-lg"
            >
              <div className="p-6 sm:p-8 md:p-10 relative">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-6 sm:mb-8 pr-8">{c.title}</h3>

                <div className="space-y-5 sm:space-y-6">
                  <div>
                    <h4 className="text-xs uppercase tracking-widest text-[#E60000] mb-2 font-mono">Problema</h4>
                    <p className="text-[#E2E8F0] text-sm sm:text-base">{c.problem}</p>
                  </div>
                  <div>
                    <h4 className="text-xs uppercase tracking-widest text-[#E60000] mb-2 font-mono">Solução Desenvolvida</h4>
                    <p className="text-[#E2E8F0] text-sm sm:text-base">{c.solution}</p>
                  </div>
                  <div className="pt-4 border-t border-white/10">
                    <h4 className="text-xs uppercase tracking-widest text-[#E60000] mb-2 font-mono">Resultado Obtido</h4>
                    <p className="text-white font-bold text-base sm:text-lg">{c.result}</p>
                  </div>
                </div>

                <div className="mt-6 sm:mt-8 flex items-center gap-2 text-sm text-[#E60000] uppercase tracking-wider font-bold group-hover:translate-x-2 transition-transform cursor-pointer">
