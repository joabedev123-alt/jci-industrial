...
export default function HeroSection() {
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      {/* Overlays mais suaves para dar destaque à imagem */}
      ...
      <div className="relative z-30 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center w-full mt-32">
        <motion.div
        ...
        >
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-2 border border-[#E60000]/30 bg-[#E60000]/10 backdrop-blur-md text-[#E60000] font-medium text-xs tracking-[0.2em] uppercase"
          >
            <Settings className="w-4 h-4 animate-spin-slow" />
            Engenharia Industrial Avançada
          </motion.div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] tracking-tighter text-white drop-shadow-2xl">
            Soluções Industriais para Operações que <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E60000] to-[#E2E8F0]">Não Podem Parar</span>
          </h1>

          <p className="text-base md:text-lg text-[#E2E8F0] max-w-2xl font-light leading-relaxed">
          ...
          <div className="flex pt-4">
            <a 
              ...
              className="group relative px-8 py-4 bg-[#E60000] text-white font-bold uppercase tracking-widest overflow-hidden transition-all duration-300 w-full sm:w-auto text-sm flex items-center justify-center gap-3 animate-[pulse_2s_infinite] hover:animate-none hover:shadow-[0_0_30px_rgba(230,0,0,0.6)] rounded-full"
            >
