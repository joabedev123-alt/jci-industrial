      ...
      <div className="relative z-30 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center w-full mt-32">
        ...
        >
          ...
          <div className="flex pt-4">
            <button className="group relative px-8 py-4 bg-[#E60000] text-white font-bold uppercase tracking-widest overflow-hidden transition-all duration-300 w-full sm:w-auto text-sm flex items-center justify-center gap-3 animate-[pulse_2s_infinite] hover:animate-none hover:shadow-[0_0_30px_rgba(230,0,0,0.6)] rounded-full">
