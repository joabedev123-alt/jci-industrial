...
export default function CtaSection() {
  return (
    <section className="relative py-20 sm:py-28 lg:py-32 px-4 sm:px-6 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center w-full">
        <motion.h2
          ...
          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 sm:mb-8 text-white drop-shadow-lg leading-tight"
        >
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl text-[#E2E8F0] mb-8 sm:mb-12 max-w-3xl mx-auto font-light px-2"
        >
        ...
        >
          <a
            ...
            className="group relative px-8 sm:px-10 py-4 sm:py-5 bg-[#E60000] text-white font-bold uppercase tracking-widest overflow-hidden transition-all duration-300 w-full sm:w-auto text-sm flex items-center justify-center gap-3 animate-[pulse_2s_infinite] hover:animate-none hover:shadow-[0_0_40px_rgba(230,0,0,0.6)] rounded-full"
          >
            <span className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
            <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" className="w-5 h-5 sm:w-6 sm:h-6 shrink-0">
