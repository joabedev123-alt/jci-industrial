  ...
  return (
    <section className="relative py-32 px-6 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <button className="group relative px-10 py-5 bg-[#E60000] text-white font-bold uppercase tracking-widest overflow-hidden transition-all duration-300 w-full sm:w-auto text-sm flex items-center justify-center gap-3 animate-[pulse_2s_infinite] hover:animate-none hover:shadow-[0_0_40px_rgba(230,0,0,0.6)] rounded-full">
