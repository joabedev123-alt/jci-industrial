    ...
    <section className="py-32 bg-[#02050A] relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Por que a <span className="text-[#E60000]">JCI Industrial?</span></h2>
          <p className="text-[#E2E8F0] max-w-2xl mx-auto text-lg">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {diffs.map((item, i) => (
            <motion.div
              ...
              className="bg-[#050B16] border border-white/5 p-8 hover:border-[#E60000]/50 hover:bg-[#0A1F44]/50 transition-all duration-300 group"
            >
              <div className="w-14 h-14 bg-[#123D8D]/30 flex items-center justify-center mb-6 group-hover:bg-[#E60000] transition-colors">
                <item.icon className="w-6 h-6 text-[#E60000] group-hover:text-white transition-colors" />
              </div>
              <h3 className="text-xl font-bold text-white mb-4">{item.title}</h3>
              <p className="text-[#E2E8F0] leading-relaxed">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
